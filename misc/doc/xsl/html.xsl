		...
		<html>
			...
			<body>
				<table align="center">
					<tr>
						<td>
							<table cellpadding="0" cellspacing="0" width="780" class="main">
								<tr>
									<td colspan="2" class="mainTitle" height="50" align="center">
										<img src="res/img/head-780x80.jpg" />
									</td>
